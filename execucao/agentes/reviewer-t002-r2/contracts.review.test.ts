...
describe('T002 reviewer round 2', () => {
  it('accepts normative string fields and finite movement values without undocumented restrictions', () => {
  ...
  it('rejects prototype-pollution keys in message payloads', () => {
